...
const float caravanCrewBubbleDrawY = SCREEN_H*1/25;
...
const float caravanInventoryBubbleDrawY = SCREEN_H*4/25;
...
const float caravanTradeRecordsBubbleDrawY = SCREEN_H* 9/25;
...
const float caravanPathfindingBubbleDrawY = SCREEN_H*22/25;
...
const float placePopulationBubbleDrawY = SCREEN_H*1/25;
...
const float placeCaravanseraiDrawY = SCREEN_H*14/25;
...
const float placeSurplusBubbleDrawY = SCREEN_H* 4/25;
...
const float placeDeficitBubbleDrawY = SCREEN_H*4/25;
...
const float placeMarketBubbleDrawY       = SCREEN_H* 4/25;
...
const float placeIndustriesBubbleDrawY = SCREEN_H*14/25;
