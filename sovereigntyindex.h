...
const std::map<int, std::string>sovereigntyNames =
{
    ...
    {SOV_VERUS_SHARUMNIR_BORDER, "Verus-Sharumnir Border"}, {SOV_VERUS_XENIA_BORDER, "Verus-Xenia Border"}, {SOV_VERUS_THOUSAND_ISLES_BORDER, "Verus-Thousand Isles Border"}
};
