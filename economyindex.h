...
const std::map<int, std::array<int,LIVING_MARKER_LAST+1>>economyBaseMaintainenceConsumptionRate = // Also known as "household consumption", as opposed to industrial consumption
{
    ...
    // Values are in hours between consumption of 1 unit.
                      //D     P     C     W      P
    {IT_MEAT,        { -1,   -1,  168,   36,   24}},
    {IT_COLD_BREATH, { -1,   -1,   -1,   72,   24}},
    {IT_CONTRACT,    { -1,   -1,  720,  168,   48}},
    {IT_SPELLBOOK,   { -1,   -1,   -1,  720,  168}},
    {IT_RICE,        { -1,  720,  168,   48,   24}},
    {IT_ALCOHOL,     {336,   72,   96,   48,   24}},
    {IT_MUSHROOMS,   { -1,   -1,   96,   72,   24}},
    {IT_HERBS,       { -1,   -1,  168,   48,   24}},
    {IT_MEDICINE,    { -1,   -1,   -1,  720,  168}},
    {IT_SPICE,       { -1,   -1,  720,  168,   48}},
    {IT_CLAY,        { -1,   -1, 2880,  336,  144}},
    {IT_POTTERY,     { -1, 4320,  720,  336,   72}},
    {IT_SILVER,      { -1,   -1,   -1, 2160,  336}},
    {IT_JEWELRY,     { -1,   -1,   -1, 1440,  336}},
    {IT_LEYSTONE,    { -1, 2160,  336,   72,   24}},
    {IT_CLOCKWORK,   { -1,   -1,   -1, 2880,  720}},
    {IT_AUTOMATON,   { -1,   -1,   -1, 8760, 2160}}
};
...
//                      Com  Hunt  Farm  Mine  Alch   Sorc  Cra   Mech
    ...
    {IT_COLD_BREATH, {   0,    1,    0,    0,    0,    1,    0,    0}},
    {IT_CONTRACT,    {   0,  0.5,    0,    0,    1,    2,  0.5,  0.5}},
    {IT_SPELLBOOK,   {   0,    0,    0,    0,    1,    1, 0.25, 0.25}},
    ...
    {IT_CLAY,        {   0,    0,  0.5,    1,    0,    2,    2,    0}},
    {IT_POTTERY,     { 0.5,    1,    1,  1.5,    1,    1,    2,    1}},
    {IT_SILVER,      { 0.5,    1,    1,    1,    1,  1.5,  1.5,  1.5}},
    {IT_JEWELRY,     { 0.5,    1,    1,    1,    1,    2,  1.5,  1.5}},
    {IT_LEYSTONE,    {   0,  1.5,    0,  1.5,    0,    1,    0,    1}},
    {IT_CLOCKWORK,   {   0,    0,  0.5,  0.5,  0.5,  0.5,    0,    2}},
    {IT_AUTOMATON,   {   0,    0,  0.5,  0.5, 0.25, 0.25,    0,    1}}
};
