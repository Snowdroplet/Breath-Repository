...
*/
    ...
    {PL_CHORAS,       { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_KETH_KETHER,  { IND_MINE_LEYSTONE, IND_MACHINE_CLOCKWORK, IND_MACHINE_AUTOMATON} },

    {PL_KETH_ENTWEIR, { IND_HUNT_MEAT, IND_FARM_CANDLECAP, IND_FARM_HERBS} },
    ...
    {PL_UMBERDELL,    { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_ALCHEMY_MEDICINE} },
    ...
    {PL_RUMNIR,       { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_HEWNHEIM,     { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_ARTAS_ROCK,   { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_VERSE,        { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },

    {PL_YHANE,        { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_VEINS,        { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_XENIA,        { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },

    {PL_TOBANDJAN,    { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_QUMANTHA,     { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },

    {PL_MAKHIA,       { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_HAPHADEE,     { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_ASTEROS,      { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },

    {PL_REACH,        { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_KARUNE,       { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_HATHSERA,     { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_DOZAAL,       { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
    {PL_YULMER,       { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },

    {PL_ETRURI,       { IND_FARM_CANDLECAP, IND_FARM_HERBS, IND_MINE_CLAY, IND_CRAFT_POTTERY} },
