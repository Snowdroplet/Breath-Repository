...
const std::map<int, std::vector<int>>placeInitialIndustries =
{
    ...
    {PL_QUELLUDE,     { IND_HUNT_STRANGE_EGG, IND_ALCHEMY_BRANDY, IND_SORCERY_CONTRACT} },
    ...
    {PL_VERSE,        { IND_HUNT_STRANGE_EGG, IND_ALCHEMY_MEDICINE, IND_ALCHEMY_ETHER, IND_SORCERY_CONTRACT, IND_SORCERY_GRIMOIRE} },
    ...
    {PL_XENIA,        { IND_HUNT_STRANGE_EGG, IND_MINE_COPPER, IND_ALCHEMY_BRANDY, IND_MACHINE_TOOLS, IND_MACHINE_CLOCKWORK, IND_MACHINE_AUTOMATON } },

    {PL_REACH,        { IND_HUNT_CORPUS, IND_MINE_CLAY, IND_MINE_LEYSTONE, IND_ALCHEMY_BRANDY, IND_SORCERY_EFFIGY, IND_MACHINE_TOOLS} },
    {PL_KARUNE,       { IND_HUNT_STRANGE_EGG, IND_FARM_HERBS, IND_MINE_COPPER, IND_ALCHEMY_ETHER, IND_ALCHEMY_COUNTERAGENT, IND_SORCERY_CONTRACT} },
