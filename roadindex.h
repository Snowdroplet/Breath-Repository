...
enum enumRoads
{
    ...
    ROAD_AMBLEFORTH_OBSERVIA = 14,
    ROAD_ROSKANEL_ROSELLA = 15, ROAD_ROSKANEL_YHANE = 16,
    ROAD_OBSERVIA_COLDLAKE = 17, ROAD_OBSERVIA_UMBERDELL = 18,
    ROAD_RAMSHORN_JASPER = 19,
    ROAD_HOLLYHEAD_RUMNIR = 20,
    ROAD_RUMNIR_HEWNHEIM = 21, ROAD_RUMNIR_ARTAS_ROCK = 22,
    ROAD_HEWNHEIM_VERSE = 23,
    ROAD_ARTAS_ROCK_VERSE = 24,
    ROAD_YHANE_VEINS = 25, ROAD_YHANE_QALAIZ = 26,
    ROAD_WATERWAY_VEINS_QUMANTH = 27,
    ROAD_QALAIZ_TOBANDJAN = 28, ROAD_QALAIZ_QUMANTH = 29, ROAD_QALAIZ_XENIA = 30
};
const unsigned ROAD_MARKER_FIRST = ROAD_ERICENNES_CHORAS;
const unsigned ROAD_MARKER_LAST = ROAD_QALAIZ_XENIA;
