...
enum enumRoads
{
    ...
    ROAD_AMBLEFORTH_OBSERVIA = 12,
    ROAD_ROSKANEL_ROSELLA = 13, ROAD_ROSKANEL_YHANE = 14,
    ROAD_OBSERVIA_COLDLAKE = 15, ROAD_OBSERVIA_UMBERDELL = 16,
    ROAD_RAMSHORN_JASPER = 17,
    ROAD_HOLLYHEAD_RUMNIR = 18,
    ROAD_RUMNIR_HEWNHEIM = 19, ROAD_RUMNIR_ARTAS_ROCK = 20,
    ROAD_HEWNHEIM_VERSE = 21,
    ROAD_ARTAS_ROCK_VERSE = 22,
    ROAD_YHANE_VEINS = 23, ROAD_YHANE_QALAIZ = 24,
    ROAD_QALAIZ_TOBANDJAN = 25, ROAD_QALAIZ_QUMANTH = 26, ROAD_QALAIZ_XENIA = 27
};
